define("page/car-apply/car-apply", function(require, exports, module) {
    ...
    module.exports = (function(lib, $, undefined) {
        ...
        var $btn_submit = $('#btn-submit'),
            ...
            OPTIONS = {
                ...
                // 缓存模板
                tmplFun: __inline('/page/car-apply/viewImg.tmpl'),
                ...
                selectFile: function() {
                    ...
                    if (currentNum >= maxuploadnum) {
                        $.info('上传张数已达上限(' + maxuploadnum + '张照片)');
                        return;
                    }
                ...
                uploadFile: function(src) {
                    ...
                    $.ajax({
                            url: '/market/customer/car/upload',
                            data: params,
                            type: 'post',
                            dataType: 'json'
                        })
                ...
                doDelete: function(ev) {
                    ...
                    $.ajax({
                            url: '/market/customer/car/upload/delete',
                            data: params,
                            type: 'post',
                            dataType: 'json'
                        })
                ...
                doReview: function(ev, imgsrc) {
                    ...
                    var _self = this,
                        ...
                        $btns = $('<div class="ui-dialog-buttons"><span class="btn-delete-txt">删除</span></div>')
                    ...
                    $btns.on('click', '.btn-delete-txt', function() {
                ...
                doSumbit: function(ev) {
                    ...
                    $.ajax({
                        url: '/market/customer/car/submit',
                        type: 'post',
                        data: $form.serialize(),
                        dataType: 'json',
